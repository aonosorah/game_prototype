...
import songsData from "../assets/day6.json";
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-4 bg-black text-white overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: `url('https://i0.wp.com/koreanmagazine.com.br/wp-content/uploads/2025/08/DAY6-anuncia-turne-comemorativa-de-10-anos-e-novo-album.jpg')`,
