...
import songsData from "../assets/data.json";
    ...
    const fetchSong = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `/api/songs?track=${encodeURIComponent(
            trackName
          )}&artist=Stray%20Kids`
        );
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-4 bg-black text-white overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: `url('https://www.musicmundial.com/en/wp-content/uploads/2025/11/Stray-Kids-teases-powerful-title-track-Do-It.jpg')`,
        ...
        {songInfo && !songInfo.error && (
          <div className="flex flex-col items-center gap-6 animate-in fade-in zoom-in duration-500 w-full max-w-2xl">
            <div className="flex gap-2">
              ...
              <span className="bg-blue-500/20 text-blue-400 text-[10px] px-3 py-1 rounded-full border border-blue-500/30 uppercase font-bold">
